...
private:
	...
	//storing the loaded textures as objects since cluster objects have a lot of inbuilt
	// parameters that make it easy for us to store information for retrieving
