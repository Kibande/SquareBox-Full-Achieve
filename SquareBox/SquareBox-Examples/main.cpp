...
int main(int argc, char** argv) {
	...
	app.run("SquareBox Example", 900, 600, windowFlags, false, SquareBox::InputDevicesEnum::KeyBoardAndMouse, SquareBox::VideoDecorderEnum::None, SquareBox::RenderEngine::ColorRGBA8(43, 43, 48, 255));
	/* Argumets
		The Windows Title
		Window Dimensions
		Window flags
