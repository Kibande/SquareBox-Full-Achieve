...
int main(int argc, char** argv) {
	...
	app.run("SquareBox Example", 900, 600,windowFlags,60,0.8f,SquareBox::InputDevicesEnum::KeyBoardAndMouse,SquareBox::VideoDecorderEnum::None,SquareBox::RenderEngine::ColorRGBA8(SquareBox::Color::grey),"Square_box_examples.log",true);
