...
struct CustomAppConsole
{
	...
	void    Draw(const char* title, bool* p_open, int width, int height)
	{
		ImGuiWindowFlags console_window_flags = 0;
		console_window_flags |= ImGuiWindowFlags_NoMove;
		console_window_flags |= ImGuiWindowFlags_NoResize;
