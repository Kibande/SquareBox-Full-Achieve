...
#ifndef FLATBUFFERS_GENERATED_DSUGWOMV1_SQUAREBOX_DSUGWOMV1_H_
#define FLATBUFFERS_GENERATED_DSUGWOMV1_SQUAREBOX_DSUGWOMV1_H_
...
struct PairOfVec2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const SquareBox::DSUGWOMV1::Vec2 *first() const {
    return GetStruct<const SquareBox::DSUGWOMV1::Vec2 *>(VT_FIRST);
  }
  const SquareBox::DSUGWOMV1::Vec2 *second() const {
    return GetStruct<const SquareBox::DSUGWOMV1::Vec2 *>(VT_SECOND);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<SquareBox::DSUGWOMV1::Vec2>(verifier, VT_FIRST) &&
           VerifyField<SquareBox::DSUGWOMV1::Vec2>(verifier, VT_SECOND) &&
           verifier.EndTable();
  }
};
...
struct PairOfVec2Builder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_first(const SquareBox::DSUGWOMV1::Vec2 *first) {
    fbb_.AddStruct(PairOfVec2::VT_FIRST, first);
  }
  void add_second(const SquareBox::DSUGWOMV1::Vec2 *second) {
...
inline flatbuffers::Offset<PairOfVec2> CreatePairOfVec2(
    flatbuffers::FlatBufferBuilder &_fbb,
    const SquareBox::DSUGWOMV1::Vec2 *first = 0,
    const SquareBox::DSUGWOMV1::Vec2 *second = 0) {
...
struct GLTexture FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const SquareBox::DSUGWOMV1::Ivec2 *tiling() const {
    return GetStruct<const SquareBox::DSUGWOMV1::Ivec2 *>(VT_TILING);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<SquareBox::DSUGWOMV1::Ivec2>(verifier, VT_TILING) &&
           verifier.EndTable();
  }
};
...
struct GLTextureBuilder {
  ...
  void add_tiling(const SquareBox::DSUGWOMV1::Ivec2 *tiling) {
...
inline flatbuffers::Offset<GLTexture> CreateGLTexture(
    ...
    const SquareBox::DSUGWOMV1::Ivec2 *tiling = 0) {
...
inline flatbuffers::Offset<GLTexture> CreateGLTextureDirect(
  ...
  return SquareBox::DSUGWOMV1::CreateGLTexture(
      _fbb,
      assets_file_path__,
      display_name__,
      tiling);
...
struct ParentTexture FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const SquareBox::DSUGWOMV1::GLTexture *texture() const {
    return GetPointer<const SquareBox::DSUGWOMV1::GLTexture *>(VT_TEXTURE);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct ParentTextureBuilder {
  ...
  void add_texture(flatbuffers::Offset<SquareBox::DSUGWOMV1::GLTexture> texture) {
...
inline flatbuffers::Offset<ParentTexture> CreateParentTexture(
    ...
    flatbuffers::Offset<SquareBox::DSUGWOMV1::GLTexture> texture = 0) {
...
struct TextureInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const SquareBox::DSUGWOMV1::Vec4 *uv_rect() const {
    return GetStruct<const SquareBox::DSUGWOMV1::Vec4 *>(VT_UV_RECT);
  }
  const SquareBox::DSUGWOMV1::Ivec4 *color() const {
    return GetStruct<const SquareBox::DSUGWOMV1::Ivec4 *>(VT_COLOR);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<SquareBox::DSUGWOMV1::Vec4>(verifier, VT_UV_RECT) &&
           VerifyField<SquareBox::DSUGWOMV1::Ivec4>(verifier, VT_COLOR) &&
...
struct TextureInfoBuilder {
  ...
  void add_uv_rect(const SquareBox::DSUGWOMV1::Vec4 *uv_rect) {
    fbb_.AddStruct(TextureInfo::VT_UV_RECT, uv_rect);
  }
  void add_color(const SquareBox::DSUGWOMV1::Ivec4 *color) {
...
inline flatbuffers::Offset<TextureInfo> CreateTextureInfo(
    ...
    const SquareBox::DSUGWOMV1::Vec4 *uv_rect = 0,
    const SquareBox::DSUGWOMV1::Ivec4 *color = 0,
    int32_t opacity = 0) {
...
inline flatbuffers::Offset<VectorOfInt> CreateVectorOfIntDirect(
  ...
  return SquareBox::DSUGWOMV1::CreateVectorOfInt(
      _fbb,
      data__);
}
...
struct Joint FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const SquareBox::DSUGWOMV1::PairOfInt *body_a_coordinates() const {
    return GetPointer<const SquareBox::DSUGWOMV1::PairOfInt *>(VT_BODY_A_COORDINATES);
  }
  const SquareBox::DSUGWOMV1::PairOfInt *body_b_coordinates() const {
    return GetPointer<const SquareBox::DSUGWOMV1::PairOfInt *>(VT_BODY_B_COORDINATES);
  }
  ...
  const SquareBox::DSUGWOMV1::Vec2 *ground_anchor_a() const {
    return GetStruct<const SquareBox::DSUGWOMV1::Vec2 *>(VT_GROUND_ANCHOR_A);
  }
  const SquareBox::DSUGWOMV1::Vec2 *ground_anchor_b() const {
    return GetStruct<const SquareBox::DSUGWOMV1::Vec2 *>(VT_GROUND_ANCHOR_B);
  }
  const SquareBox::DSUGWOMV1::Vec2 *local_anchor_a() const {
    return GetStruct<const SquareBox::DSUGWOMV1::Vec2 *>(VT_LOCAL_ANCHOR_A);
  }
  const SquareBox::DSUGWOMV1::Vec2 *local_anchor_b() const {
    return GetStruct<const SquareBox::DSUGWOMV1::Vec2 *>(VT_LOCAL_ANCHOR_B);
  }
  const flatbuffers::Vector<const SquareBox::DSUGWOMV1::Vec2 *> *vec_of_points() const {
    return GetPointer<const flatbuffers::Vector<const SquareBox::DSUGWOMV1::Vec2 *> *>(VT_VEC_OF_POINTS);
  }
  const SquareBox::DSUGWOMV1::Vec2 *local_axis_a() const {
    return GetStruct<const SquareBox::DSUGWOMV1::Vec2 *>(VT_LOCAL_AXIS_A);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<SquareBox::DSUGWOMV1::Vec2>(verifier, VT_GROUND_ANCHOR_A) &&
           VerifyField<SquareBox::DSUGWOMV1::Vec2>(verifier, VT_GROUND_ANCHOR_B) &&
           VerifyField<SquareBox::DSUGWOMV1::Vec2>(verifier, VT_LOCAL_ANCHOR_A) &&
           VerifyField<SquareBox::DSUGWOMV1::Vec2>(verifier, VT_LOCAL_ANCHOR_B) &&
           VerifyOffset(verifier, VT_VEC_OF_POINTS) &&
           verifier.VerifyVector(vec_of_points()) &&
           VerifyField<SquareBox::DSUGWOMV1::Vec2>(verifier, VT_LOCAL_AXIS_A) &&
...
struct JointBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_body_a_coordinates(flatbuffers::Offset<SquareBox::DSUGWOMV1::PairOfInt> body_a_coordinates) {
    fbb_.AddOffset(Joint::VT_BODY_A_COORDINATES, body_a_coordinates);
  }
  void add_body_b_coordinates(flatbuffers::Offset<SquareBox::DSUGWOMV1::PairOfInt> body_b_coordinates) {
  ...
  void add_ground_anchor_a(const SquareBox::DSUGWOMV1::Vec2 *ground_anchor_a) {
    fbb_.AddStruct(Joint::VT_GROUND_ANCHOR_A, ground_anchor_a);
  }
  void add_ground_anchor_b(const SquareBox::DSUGWOMV1::Vec2 *ground_anchor_b) {
    fbb_.AddStruct(Joint::VT_GROUND_ANCHOR_B, ground_anchor_b);
  }
  void add_local_anchor_a(const SquareBox::DSUGWOMV1::Vec2 *local_anchor_a) {
    fbb_.AddStruct(Joint::VT_LOCAL_ANCHOR_A, local_anchor_a);
  }
  void add_local_anchor_b(const SquareBox::DSUGWOMV1::Vec2 *local_anchor_b) {
    fbb_.AddStruct(Joint::VT_LOCAL_ANCHOR_B, local_anchor_b);
  }
  void add_vec_of_points(flatbuffers::Offset<flatbuffers::Vector<const SquareBox::DSUGWOMV1::Vec2 *>> vec_of_points) {
    fbb_.AddOffset(Joint::VT_VEC_OF_POINTS, vec_of_points);
  }
  void add_local_axis_a(const SquareBox::DSUGWOMV1::Vec2 *local_axis_a) {
...
inline flatbuffers::Offset<Joint> CreateJoint(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<SquareBox::DSUGWOMV1::PairOfInt> body_a_coordinates = 0,
    flatbuffers::Offset<SquareBox::DSUGWOMV1::PairOfInt> body_b_coordinates = 0,
    ...
    float damping = 0.0f,
    const SquareBox::DSUGWOMV1::Vec2 *ground_anchor_a = 0,
    const SquareBox::DSUGWOMV1::Vec2 *ground_anchor_b = 0,
    const SquareBox::DSUGWOMV1::Vec2 *local_anchor_a = 0,
    const SquareBox::DSUGWOMV1::Vec2 *local_anchor_b = 0,
    flatbuffers::Offset<flatbuffers::Vector<const SquareBox::DSUGWOMV1::Vec2 *>> vec_of_points = 0,
    const SquareBox::DSUGWOMV1::Vec2 *local_axis_a = 0,
...
inline flatbuffers::Offset<Joint> CreateJointDirect(
    ...
    const SquareBox::DSUGWOMV1::Vec2 *local_anchor_a = 0,
    const SquareBox::DSUGWOMV1::Vec2 *local_anchor_b = 0,
    const std::vector<SquareBox::DSUGWOMV1::Vec2> *vec_of_points = nullptr,
    const SquareBox::DSUGWOMV1::Vec2 *local_axis_a = 0,
    int32_t joint_type = 0) {
  auto vec_of_points__ = vec_of_points ? _fbb.CreateVectorOfStructs<SquareBox::DSUGWOMV1::Vec2>(*vec_of_points) : 0;
  return SquareBox::DSUGWOMV1::CreateJoint(
      _fbb,
      body_a_coordinates,
      body_b_coordinates,
...
struct ClusterObject FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::PairOfVec2>> *vec_of_edges() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::PairOfVec2>> *>(VT_VEC_OF_EDGES);
  }
  const flatbuffers::Vector<const SquareBox::DSUGWOMV1::Vec2 *> *vertices() const {
    return GetPointer<const flatbuffers::Vector<const SquareBox::DSUGWOMV1::Vec2 *> *>(VT_VERTICES);
  }
  const SquareBox::DSUGWOMV1::Vec2 *off_set() const {
    return GetStruct<const SquareBox::DSUGWOMV1::Vec2 *>(VT_OFF_SET);
  }
  const SquareBox::DSUGWOMV1::Vec2 *position() const {
    return GetStruct<const SquareBox::DSUGWOMV1::Vec2 *>(VT_POSITION);
  }
  const SquareBox::DSUGWOMV1::Vec2 *init_linear_velocity() const {
    return GetStruct<const SquareBox::DSUGWOMV1::Vec2 *>(VT_INIT_LINEAR_VELOCITY);
  }
  const SquareBox::DSUGWOMV1::Vec2 *direction() const {
    return GetStruct<const SquareBox::DSUGWOMV1::Vec2 *>(VT_DIRECTION);
  }
  float speed() const {
  ...
  const SquareBox::DSUGWOMV1::TextureInfo *texture_info() const {
    return GetPointer<const SquareBox::DSUGWOMV1::TextureInfo *>(VT_TEXTURE_INFO);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<SquareBox::DSUGWOMV1::Vec2>(verifier, VT_OFF_SET) &&
           VerifyField<SquareBox::DSUGWOMV1::Vec2>(verifier, VT_POSITION) &&
           VerifyField<SquareBox::DSUGWOMV1::Vec2>(verifier, VT_INIT_LINEAR_VELOCITY) &&
           VerifyField<SquareBox::DSUGWOMV1::Vec2>(verifier, VT_DIRECTION) &&
...
struct ClusterObjectBuilder {
  ...
  void add_vec_of_edges(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::PairOfVec2>>> vec_of_edges) {
    fbb_.AddOffset(ClusterObject::VT_VEC_OF_EDGES, vec_of_edges);
  }
  void add_vertices(flatbuffers::Offset<flatbuffers::Vector<const SquareBox::DSUGWOMV1::Vec2 *>> vertices) {
    fbb_.AddOffset(ClusterObject::VT_VERTICES, vertices);
  }
  void add_off_set(const SquareBox::DSUGWOMV1::Vec2 *off_set) {
    fbb_.AddStruct(ClusterObject::VT_OFF_SET, off_set);
  }
  void add_position(const SquareBox::DSUGWOMV1::Vec2 *position) {
    fbb_.AddStruct(ClusterObject::VT_POSITION, position);
  }
  void add_init_linear_velocity(const SquareBox::DSUGWOMV1::Vec2 *init_linear_velocity) {
    fbb_.AddStruct(ClusterObject::VT_INIT_LINEAR_VELOCITY, init_linear_velocity);
  }
  void add_direction(const SquareBox::DSUGWOMV1::Vec2 *direction) {
  ...
  void add_texture_info(flatbuffers::Offset<SquareBox::DSUGWOMV1::TextureInfo> texture_info) {
...
inline flatbuffers::Offset<ClusterObject> CreateClusterObject(
    ...
    int32_t shape = 0,
    int32_t type = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::PairOfVec2>>> vec_of_edges = 0,
    flatbuffers::Offset<flatbuffers::Vector<const SquareBox::DSUGWOMV1::Vec2 *>> vertices = 0,
    const SquareBox::DSUGWOMV1::Vec2 *off_set = 0,
    const SquareBox::DSUGWOMV1::Vec2 *position = 0,
    const SquareBox::DSUGWOMV1::Vec2 *init_linear_velocity = 0,
    const SquareBox::DSUGWOMV1::Vec2 *direction = 0,
    float speed = 0.0f,
    int32_t physics_properties = 0,
    flatbuffers::Offset<SquareBox::DSUGWOMV1::TextureInfo> texture_info = 0) {
...
inline flatbuffers::Offset<ClusterObject> CreateClusterObjectDirect(
    ...
    int32_t shape = 0,
    int32_t type = 0,
    const std::vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::PairOfVec2>> *vec_of_edges = nullptr,
    const std::vector<SquareBox::DSUGWOMV1::Vec2> *vertices = nullptr,
    const SquareBox::DSUGWOMV1::Vec2 *off_set = 0,
    const SquareBox::DSUGWOMV1::Vec2 *position = 0,
    const SquareBox::DSUGWOMV1::Vec2 *init_linear_velocity = 0,
    const SquareBox::DSUGWOMV1::Vec2 *direction = 0,
  ...
  auto vec_of_edges__ = vec_of_edges ? _fbb.CreateVector<flatbuffers::Offset<SquareBox::DSUGWOMV1::PairOfVec2>>(*vec_of_edges) : 0;
  auto vertices__ = vertices ? _fbb.CreateVectorOfStructs<SquareBox::DSUGWOMV1::Vec2>(*vertices) : 0;
  return SquareBox::DSUGWOMV1::CreateClusterObject(
      _fbb,
      layer_index,
      cluster_index,
      index,
...
struct WorldCluster FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ClusterObject>> *cluster_objects() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ClusterObject>> *>(VT_CLUSTER_OBJECTS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_INDEX) &&
...
struct WorldClusterBuilder {
  ...
  void add_cluster_objects(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ClusterObject>>> cluster_objects) {
...
inline flatbuffers::Offset<WorldCluster> CreateWorldCluster(
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ClusterObject>>> cluster_objects = 0) {
...
inline flatbuffers::Offset<WorldCluster> CreateWorldClusterDirect(
    ...
    const char *name = nullptr,
    bool is_selected = false,
    const std::vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ClusterObject>> *cluster_objects = nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  auto cluster_objects__ = cluster_objects ? _fbb.CreateVector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ClusterObject>>(*cluster_objects) : 0;
  return SquareBox::DSUGWOMV1::CreateWorldCluster(
      _fbb,
      index,
      deletion_index,
      name__,
...
struct Layer FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ParentTexture>> *single_textures() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ParentTexture>> *>(VT_SINGLE_TEXTURES);
  }
  const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ParentTexture>> *tiled_textures() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ParentTexture>> *>(VT_TILED_TEXTURES);
  }
  const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::SubTexture>> *sub_textures() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::SubTexture>> *>(VT_SUB_TEXTURES);
  }
  ...
  const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::PairOfInt>> *alive_cluster_objects() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::PairOfInt>> *>(VT_ALIVE_CLUSTER_OBJECTS);
  }
  const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::Joint>> *active_joints() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::Joint>> *>(VT_ACTIVE_JOINTS);
  }
  const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::WorldCluster>> *world_clusters() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::WorldCluster>> *>(VT_WORLD_CLUSTERS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_NAME) &&
...
struct LayerBuilder {
  ...
  void add_single_textures(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ParentTexture>>> single_textures) {
    fbb_.AddOffset(Layer::VT_SINGLE_TEXTURES, single_textures);
  }
  void add_tiled_textures(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ParentTexture>>> tiled_textures) {
    fbb_.AddOffset(Layer::VT_TILED_TEXTURES, tiled_textures);
  }
  void add_sub_textures(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::SubTexture>>> sub_textures) {
  ...
  void add_alive_cluster_objects(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::PairOfInt>>> alive_cluster_objects) {
    fbb_.AddOffset(Layer::VT_ALIVE_CLUSTER_OBJECTS, alive_cluster_objects);
  }
  void add_active_joints(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::Joint>>> active_joints) {
    fbb_.AddOffset(Layer::VT_ACTIVE_JOINTS, active_joints);
  }
  void add_world_clusters(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::WorldCluster>>> world_clusters) {
...
inline flatbuffers::Offset<Layer> CreateLayer(
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ParentTexture>>> single_textures = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ParentTexture>>> tiled_textures = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::SubTexture>>> sub_textures = 0,
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::PairOfInt>>> alive_cluster_objects = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::Joint>>> active_joints = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::WorldCluster>>> world_clusters = 0) {
...
inline flatbuffers::Offset<Layer> CreateLayerDirect(
    ...
    bool is_locked = false,
    int32_t layer_type = 0,
    const std::vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ParentTexture>> *single_textures = nullptr,
    const std::vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ParentTexture>> *tiled_textures = nullptr,
    const std::vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::SubTexture>> *sub_textures = nullptr,
    float tile_system_orign_x = 0.0f,
    float tile_system_orign_y = 0.0f,
    float tile_system_width = 0.0f,
    float tile_system_height = 0.0f,
    ...
    const std::vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::PairOfInt>> *alive_cluster_objects = nullptr,
    const std::vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::Joint>> *active_joints = nullptr,
    const std::vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::WorldCluster>> *world_clusters = nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  auto single_textures__ = single_textures ? _fbb.CreateVector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ParentTexture>>(*single_textures) : 0;
  auto tiled_textures__ = tiled_textures ? _fbb.CreateVector<flatbuffers::Offset<SquareBox::DSUGWOMV1::ParentTexture>>(*tiled_textures) : 0;
  auto sub_textures__ = sub_textures ? _fbb.CreateVector<flatbuffers::Offset<SquareBox::DSUGWOMV1::SubTexture>>(*sub_textures) : 0;
  auto tile_system_data__ = tile_system_data ? _fbb.CreateVector<int32_t>(*tile_system_data) : 0;
  auto alive_cluster_objects__ = alive_cluster_objects ? _fbb.CreateVector<flatbuffers::Offset<SquareBox::DSUGWOMV1::PairOfInt>>(*alive_cluster_objects) : 0;
  auto active_joints__ = active_joints ? _fbb.CreateVector<flatbuffers::Offset<SquareBox::DSUGWOMV1::Joint>>(*active_joints) : 0;
  auto world_clusters__ = world_clusters ? _fbb.CreateVector<flatbuffers::Offset<SquareBox::DSUGWOMV1::WorldCluster>>(*world_clusters) : 0;
  return SquareBox::DSUGWOMV1::CreateLayer(
      _fbb,
      name__,
      opacity,
      is_visible,
...
struct SquareBoxLevel FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_EDITING_SCREEN_DIMENSIONS = 8,
    VT_ACTIVE_CAMERA_INDEX = 10,
    VT_LAYERS = 12
  };
  float camera_scale() const {
    return GetField<float>(VT_CAMERA_SCALE, 0.0f);
  }
  const SquareBox::DSUGWOMV1::Vec2 *camera_position() const {
    return GetStruct<const SquareBox::DSUGWOMV1::Vec2 *>(VT_CAMERA_POSITION);
  }
  const SquareBox::DSUGWOMV1::Vec2 *editing_screen_dimensions() const {
    return GetStruct<const SquareBox::DSUGWOMV1::Vec2 *>(VT_EDITING_SCREEN_DIMENSIONS);
  }
  int32_t active_camera_index() const {
    return GetField<int32_t>(VT_ACTIVE_CAMERA_INDEX, 0);
  }
  const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::Layer>> *layers() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::Layer>> *>(VT_LAYERS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<float>(verifier, VT_CAMERA_SCALE) &&
           VerifyField<SquareBox::DSUGWOMV1::Vec2>(verifier, VT_CAMERA_POSITION) &&
           VerifyField<SquareBox::DSUGWOMV1::Vec2>(verifier, VT_EDITING_SCREEN_DIMENSIONS) &&
...
struct SquareBoxLevelBuilder {
  ...
  void add_camera_position(const SquareBox::DSUGWOMV1::Vec2 *camera_position) {
    fbb_.AddStruct(SquareBoxLevel::VT_CAMERA_POSITION, camera_position);
  }
  void add_editing_screen_dimensions(const SquareBox::DSUGWOMV1::Vec2 *editing_screen_dimensions) {
    fbb_.AddStruct(SquareBoxLevel::VT_EDITING_SCREEN_DIMENSIONS, editing_screen_dimensions);
  }
  ...
  void add_layers(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::Layer>>> layers) {
...
inline flatbuffers::Offset<SquareBoxLevel> CreateSquareBoxLevel(
    ...
    const SquareBox::DSUGWOMV1::Vec2 *camera_position = 0,
    const SquareBox::DSUGWOMV1::Vec2 *editing_screen_dimensions = 0,
    int32_t active_camera_index = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::Layer>>> layers = 0) {
  SquareBoxLevelBuilder builder_(_fbb);
  builder_.add_layers(layers);
  builder_.add_active_camera_index(active_camera_index);
  builder_.add_editing_screen_dimensions(editing_screen_dimensions);
...
inline flatbuffers::Offset<SquareBoxLevel> CreateSquareBoxLevelDirect(
    ...
    const SquareBox::DSUGWOMV1::Vec2 *editing_screen_dimensions = 0,
    int32_t active_camera_index = 0,
    const std::vector<flatbuffers::Offset<SquareBox::DSUGWOMV1::Layer>> *layers = nullptr) {
  auto layers__ = layers ? _fbb.CreateVector<flatbuffers::Offset<SquareBox::DSUGWOMV1::Layer>>(*layers) : 0;
  return SquareBox::DSUGWOMV1::CreateSquareBoxLevel(
      _fbb,
      camera_scale,
      camera_position,
      editing_screen_dimensions,
      active_camera_index,
      layers__);
}

inline const SquareBox::DSUGWOMV1::SquareBoxLevel *GetSquareBoxLevel(const void *buf) {
  return flatbuffers::GetRoot<SquareBox::DSUGWOMV1::SquareBoxLevel>(buf);
}

inline const SquareBox::DSUGWOMV1::SquareBoxLevel *GetSizePrefixedSquareBoxLevel(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<SquareBox::DSUGWOMV1::SquareBoxLevel>(buf);
}

inline bool VerifySquareBoxLevelBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SquareBox::DSUGWOMV1::SquareBoxLevel>(nullptr);
}

inline bool VerifySizePrefixedSquareBoxLevelBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SquareBox::DSUGWOMV1::SquareBoxLevel>(nullptr);
}

inline void FinishSquareBoxLevelBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<SquareBox::DSUGWOMV1::SquareBoxLevel> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_DSUGWOMV1_SQUAREBOX_DSUGWOMV1_H_
