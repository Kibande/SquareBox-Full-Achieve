#include "OldLevelReaderWriter.h"
...
namespace SquareBox {
	...
	namespace GWOM
	{
		bool OldLevelReaderWriter::saveLevelDataAsBinary(const std::string& file_path_,const std::vector<SquareBox::GWOM::Layer>& layers_, float active_camera_scale_, const glm::vec2& active_camera_position_, int active_camera_index_)
		{
			try
			{
		...
		bool OldLevelReaderWriter::loadLevelDataAsBinary(const std::string& filePath,std::vector<SquareBox::GWOM::Layer>& layers_, float & active_camera_scale_, glm::vec2& active_camera_position_, int  & active_camera_index_)
		{
