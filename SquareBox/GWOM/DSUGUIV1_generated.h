...
#ifndef FLATBUFFERS_GENERATED_DSUGUIV1_SQUAREBOX_DSUGUIV1_H_
#define FLATBUFFERS_GENERATED_DSUGUIV1_SQUAREBOX_DSUGUIV1_H_
...
struct PairOfVec2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const SquareBox::DSUGUIV1::Vec2 *first() const {
    return GetStruct<const SquareBox::DSUGUIV1::Vec2 *>(VT_FIRST);
  }
  const SquareBox::DSUGUIV1::Vec2 *second() const {
    return GetStruct<const SquareBox::DSUGUIV1::Vec2 *>(VT_SECOND);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<SquareBox::DSUGUIV1::Vec2>(verifier, VT_FIRST) &&
           VerifyField<SquareBox::DSUGUIV1::Vec2>(verifier, VT_SECOND) &&
           verifier.EndTable();
  }
};
...
struct PairOfVec2Builder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_first(const SquareBox::DSUGUIV1::Vec2 *first) {
    fbb_.AddStruct(PairOfVec2::VT_FIRST, first);
  }
  void add_second(const SquareBox::DSUGUIV1::Vec2 *second) {
...
inline flatbuffers::Offset<PairOfVec2> CreatePairOfVec2(
    flatbuffers::FlatBufferBuilder &_fbb,
    const SquareBox::DSUGUIV1::Vec2 *first = 0,
    const SquareBox::DSUGUIV1::Vec2 *second = 0) {
...
struct GLTexture FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const SquareBox::DSUGUIV1::Ivec2 *tiling() const {
    return GetStruct<const SquareBox::DSUGUIV1::Ivec2 *>(VT_TILING);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<SquareBox::DSUGUIV1::Ivec2>(verifier, VT_TILING) &&
           verifier.EndTable();
  }
};
...
struct GLTextureBuilder {
  ...
  void add_tiling(const SquareBox::DSUGUIV1::Ivec2 *tiling) {
...
inline flatbuffers::Offset<GLTexture> CreateGLTexture(
    ...
    const SquareBox::DSUGUIV1::Ivec2 *tiling = 0) {
...
inline flatbuffers::Offset<GLTexture> CreateGLTextureDirect(
  ...
  return SquareBox::DSUGUIV1::CreateGLTexture(
      _fbb,
      assets_file_path__,
      display_name__,
      tiling);
...
inline flatbuffers::Offset<SpriteFont> CreateSpriteFontDirect(
  ...
  auto display_name__ = display_name ? _fbb.CreateString(display_name) : 0;
  return SquareBox::DSUGUIV1::CreateSpriteFont(
      _fbb,
      font_path__,
      display_name__,
      font_size);
...
struct TextureInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const SquareBox::DSUGUIV1::Vec4 *uv_rect() const {
    return GetStruct<const SquareBox::DSUGUIV1::Vec4 *>(VT_UV_RECT);
  }
  const SquareBox::DSUGUIV1::Ivec4 *color() const {
    return GetStruct<const SquareBox::DSUGUIV1::Ivec4 *>(VT_COLOR);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<SquareBox::DSUGUIV1::Vec4>(verifier, VT_UV_RECT) &&
           VerifyField<SquareBox::DSUGUIV1::Ivec4>(verifier, VT_COLOR) &&
...
struct TextureInfoBuilder {
  ...
  void add_uv_rect(const SquareBox::DSUGUIV1::Vec4 *uv_rect) {
    fbb_.AddStruct(TextureInfo::VT_UV_RECT, uv_rect);
  }
  void add_color(const SquareBox::DSUGUIV1::Ivec4 *color) {
...
inline flatbuffers::Offset<TextureInfo> CreateTextureInfo(
    ...
    const SquareBox::DSUGUIV1::Vec4 *uv_rect = 0,
    const SquareBox::DSUGUIV1::Ivec4 *color = 0,
    int32_t opacity = 0) {
...
inline flatbuffers::Offset<FontInfo> CreateFontInfoDirect(
  ...
  return SquareBox::DSUGUIV1::CreateFontInfo(
      _fbb,
      color,
      font_index,
      text__,
...
struct GUIElement FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const SquareBox::DSUGUIV1::Vec2 *location_ratio() const {
    return GetStruct<const SquareBox::DSUGUIV1::Vec2 *>(VT_LOCATION_RATIO);
  }
  ...
  const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::FontInfo>> *fonts() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::FontInfo>> *>(VT_FONTS);
  }
  const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::TextureInfo>> *textures() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::TextureInfo>> *>(VT_TEXTURES);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<SquareBox::DSUGUIV1::Vec2>(verifier, VT_LOCATION_RATIO) &&
...
struct GUIElementBuilder {
  ...
  void add_location_ratio(const SquareBox::DSUGUIV1::Vec2 *location_ratio) {
  ...
  void add_fonts(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::FontInfo>>> fonts) {
    fbb_.AddOffset(GUIElement::VT_FONTS, fonts);
  }
  void add_textures(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::TextureInfo>>> textures) {
...
inline flatbuffers::Offset<GUIElement> CreateGUIElement(
    ...
    const SquareBox::DSUGUIV1::Vec2 *location_ratio = 0,
    float height_ratio = 0.0f,
    float width_ratio = 0.0f,
    float radius_ratio = 0.0f,
    float angle = 0.0f,
    bool is_alive = false,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::FontInfo>>> fonts = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::TextureInfo>>> textures = 0) {
...
inline flatbuffers::Offset<GUIElement> CreateGUIElementDirect(
    ...
    float angle = 0.0f,
    bool is_alive = false,
    const std::vector<flatbuffers::Offset<SquareBox::DSUGUIV1::FontInfo>> *fonts = nullptr,
    const std::vector<flatbuffers::Offset<SquareBox::DSUGUIV1::TextureInfo>> *textures = nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  auto fonts__ = fonts ? _fbb.CreateVector<flatbuffers::Offset<SquareBox::DSUGUIV1::FontInfo>>(*fonts) : 0;
  auto textures__ = textures ? _fbb.CreateVector<flatbuffers::Offset<SquareBox::DSUGUIV1::TextureInfo>>(*textures) : 0;
  return SquareBox::DSUGUIV1::CreateGUIElement(
      _fbb,
      shape,
      state,
      id,
...
struct SquareBoxGuiLayer FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_TILED_TEXTURES = 8,
    VT_SPRITE_FONTS = 10,
    VT_EDITING_SCREEN_DIMENSIONS = 12
  };
  const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::GUIElement>> *gui_elements() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::GUIElement>> *>(VT_GUI_ELEMENTS);
  }
  const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::GLTexture>> *single_textures() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::GLTexture>> *>(VT_SINGLE_TEXTURES);
  }
  const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::GLTexture>> *tiled_textures() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::GLTexture>> *>(VT_TILED_TEXTURES);
  }
  const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::SpriteFont>> *sprite_fonts() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::SpriteFont>> *>(VT_SPRITE_FONTS);
  }
  const SquareBox::DSUGUIV1::Vec2 *editing_screen_dimensions() const {
    return GetStruct<const SquareBox::DSUGUIV1::Vec2 *>(VT_EDITING_SCREEN_DIMENSIONS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<SquareBox::DSUGUIV1::Vec2>(verifier, VT_EDITING_SCREEN_DIMENSIONS) &&
           verifier.EndTable();
  }
};
...
struct SquareBoxGuiLayerBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_gui_elements(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::GUIElement>>> gui_elements) {
    fbb_.AddOffset(SquareBoxGuiLayer::VT_GUI_ELEMENTS, gui_elements);
  }
  void add_single_textures(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::GLTexture>>> single_textures) {
    fbb_.AddOffset(SquareBoxGuiLayer::VT_SINGLE_TEXTURES, single_textures);
  }
  void add_tiled_textures(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::GLTexture>>> tiled_textures) {
    fbb_.AddOffset(SquareBoxGuiLayer::VT_TILED_TEXTURES, tiled_textures);
  }
  void add_sprite_fonts(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::SpriteFont>>> sprite_fonts) {
    fbb_.AddOffset(SquareBoxGuiLayer::VT_SPRITE_FONTS, sprite_fonts);
  }
  void add_editing_screen_dimensions(const SquareBox::DSUGUIV1::Vec2 *editing_screen_dimensions) {
...
inline flatbuffers::Offset<SquareBoxGuiLayer> CreateSquareBoxGuiLayer(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::GUIElement>>> gui_elements = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::GLTexture>>> single_textures = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::GLTexture>>> tiled_textures = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SquareBox::DSUGUIV1::SpriteFont>>> sprite_fonts = 0,
    const SquareBox::DSUGUIV1::Vec2 *editing_screen_dimensions = 0) {
...
inline flatbuffers::Offset<SquareBoxGuiLayer> CreateSquareBoxGuiLayerDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<SquareBox::DSUGUIV1::GUIElement>> *gui_elements = nullptr,
    const std::vector<flatbuffers::Offset<SquareBox::DSUGUIV1::GLTexture>> *single_textures = nullptr,
    const std::vector<flatbuffers::Offset<SquareBox::DSUGUIV1::GLTexture>> *tiled_textures = nullptr,
    const std::vector<flatbuffers::Offset<SquareBox::DSUGUIV1::SpriteFont>> *sprite_fonts = nullptr,
    const SquareBox::DSUGUIV1::Vec2 *editing_screen_dimensions = 0) {
  auto gui_elements__ = gui_elements ? _fbb.CreateVector<flatbuffers::Offset<SquareBox::DSUGUIV1::GUIElement>>(*gui_elements) : 0;
  auto single_textures__ = single_textures ? _fbb.CreateVector<flatbuffers::Offset<SquareBox::DSUGUIV1::GLTexture>>(*single_textures) : 0;
  auto tiled_textures__ = tiled_textures ? _fbb.CreateVector<flatbuffers::Offset<SquareBox::DSUGUIV1::GLTexture>>(*tiled_textures) : 0;
  auto sprite_fonts__ = sprite_fonts ? _fbb.CreateVector<flatbuffers::Offset<SquareBox::DSUGUIV1::SpriteFont>>(*sprite_fonts) : 0;
  return SquareBox::DSUGUIV1::CreateSquareBoxGuiLayer(
      _fbb,
      gui_elements__,
      single_textures__,
      tiled_textures__,
...
inline const SquareBox::DSUGUIV1::SquareBoxGuiLayer *GetSquareBoxGuiLayer(const void *buf) {
  return flatbuffers::GetRoot<SquareBox::DSUGUIV1::SquareBoxGuiLayer>(buf);
}

inline const SquareBox::DSUGUIV1::SquareBoxGuiLayer *GetSizePrefixedSquareBoxGuiLayer(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<SquareBox::DSUGUIV1::SquareBoxGuiLayer>(buf);
}

inline bool VerifySquareBoxGuiLayerBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SquareBox::DSUGUIV1::SquareBoxGuiLayer>(nullptr);
}

inline bool VerifySizePrefixedSquareBoxGuiLayerBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SquareBox::DSUGUIV1::SquareBoxGuiLayer>(nullptr);
}

inline void FinishSquareBoxGuiLayerBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<SquareBox::DSUGUIV1::SquareBoxGuiLayer> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_DSUGUIV1_SQUAREBOX_DSUGUIV1_H_
