project "Physics-Collision-Engine"
	kind "StaticLib"
	language "C++"
	staticruntime "on"
	...
	filter "system:windows"
		...
		defines 
		{
			"SQBPHYSICSCOLLISIONENGINE_PLATFORM_WINDOWS"
		}

	filter "configurations:Debug"
		defines { "SQBPHYSICSCOLLISIONENGINE_DEBUG" }
		runtime "Debug"
		symbols "On"

	filter "configurations:Release"
		defines { "SQBPHYSICSCOLLISIONENGINE_RELEASE" }
		runtime "Release"
		optimize "On"

	filter "configurations:Dist"
		defines { "SQBPHYSICSCOLLISIONENGINE_DIST" }
		--runtime "Dist"
		optimize "On"